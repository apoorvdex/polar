...
export class AnnotationSidebar extends React.Component<IProps, IState> {
    ...
    constructor(props: IProps, context: any) {
        ...
        setTimeout(() => {
            this.registerOnDeleteAnnotationListener();
            this.registerGettingAnnotationRefById();
        }, 100);
    }
    ...
    private registerOnDeleteAnnotationListener() {
        InteleasePdfReader.getInstance().registerAnnotationDeleteFn((highlight: any) => {
            this.state.annotations.forEach((annotation: any) => {
                if (annotation.id === highlight.id) {
    ...
    private registerGettingAnnotationRefById() {
        InteleasePdfReader.getInstance().registerGettingAnnotationRefByIdFn((annotationId: any) => {
            return this.state.annotations.find((annotation: any) => {
